function plot_box_acc_gfa_diff_fixed_loss_pnas
    ...
    load('D:\Users\Vishwesh\PycharmProjects\Deep_Null_Space\py_code\Null_space_CV_extended_loss_PNAS_gfa\TS04\result_NSDN_3ta.mat')
    ts4_nsdn_3ta = predicted;
    clear predicted
    load('D:\Users\Vishwesh\PycharmProjects\Deep_Null_Space\py_code\Null_space_CV_extended_loss_PNAS_gfa\TS04\result_NSDN_3tb.mat')
    ...
    % Load NSDN
    load('D:\Users\Vishwesh\PycharmProjects\Deep_Null_Space\py_code\Null_space_CV_extended_loss_PNAS_gfa\TS01\result_NSDN_3tb.mat')
    ts1_nsdn_3tb = predicted;
    clear predicted
    load('D:\Users\Vishwesh\PycharmProjects\Deep_Null_Space\py_code\Null_space_CV_extended_loss_PNAS_gfa\TS01\result_NSDN_austin.mat')
    ...
    ts4_nsdn_3ta = ts4_nsdn_3ta(:,91:end);
    ts4_nsdn_3tb = ts4_nsdn_3tb(:,91:end);
    ts1_nsdn_3tb = ts1_nsdn_3tb(:,91:end);
    ts1_nsdn_austin = ts1_nsdn_austin(:,91:end);
