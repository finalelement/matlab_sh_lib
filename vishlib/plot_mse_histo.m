function plot_mse_histo
    
    % 4th Order
    %load('result_b3000_testing_4th_order.mat')
    %load('result_b6000_testing_4th_order.mat')
    %load('result_b9000_testing_4th_order.mat')
    %load('result_b12000_testing_4th_order.mat')
    
    % 6th Order
    %load('result_b3000_testing_6th_order.mat')
    %load('result_b6000_testing_6th_order.mat')
    %load('result_b9000_testing_6th_order.mat')
    %load('result_b12000_testing_6th_order.mat')
    
    % 8th Order
    %load('result_b3000_testing_8th_order.mat')
    %load('result_b6000_testing_8th_order.mat')
    %load('result_b9000_testing_8th_order.mat')
    %load('result_b12000_testing_8th_order.mat')
