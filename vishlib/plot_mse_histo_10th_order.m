function plot_mse_histo_10th_order
    ...
    load('my_outcome_testing_10th_order_two_shells.mat')
    load('out_matrix.mat')
    load('CSDmatrix.mat')
    ...
    out_true_orig = out_matrix(50001:57267,:);
    out_csd_preds = CSDmatrix(50001:57267,:);
    ...
    men = mean(acc_vector);
    dl_title_name = sprintf('ACC dist b/w True,Pred Median - %0.4f Mean - %0.4f',med,men);
    title(dl_title_name)
    ...
    csd_title_name = sprintf('CSD ACC dist b/w True,Pred Median - %0.4f Mean - %0.4f',med_csd,men_csd);
